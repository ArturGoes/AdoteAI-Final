...
const AdoptionContractPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
        ...
        toast({
            ...
            description: `Sua visita para conhecer ${animal.nome} foi agendada.`,
        });
        ...
        toast({
            title: "Erro",
            description: "Ocorreu um erro ao agendar. Tente novamente.",
            variant: "destructive"
        });
    } finally {
  ...
  const animalImage = animal.imagemUrl || `https://source.unsplash.com/200x200/?${animal.raça || 'dog'}`;
          ...
          <CardContent className="pt-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                {/* Ajuste para garantir compatibilidade de tipos entre mock e API real */}
                <p className="text-muted-foreground">
                    {animal.raça} • {typeof animal.idade === 'number' ? `${animal.idade} anos` : animal.idade} • {animal.porte || (animal as any).tamanho}
                </p>
